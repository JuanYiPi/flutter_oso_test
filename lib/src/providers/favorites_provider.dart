...
class FavoritesProvider {
  ...
  Future<List<Product>> getFavorites() async {
    ...
    final url = Uri.https(authority, '${prefs.rutaAlmacen}api/api/users/${prefs.idUsuario}/favorites', {
      'api_key' : apiKey,
    });
  ...
  Future<bool> addToFavorite(String productId) async {
    ...
    final url = Uri.https(authority, '${prefs.rutaAlmacen}api/api/favorites');
  ...
  Future<bool> deleteFavorite(String productId) async {
    ...
    final url = Uri.https(authority, '${prefs.rutaAlmacen}api/api/users/${prefs.idUsuario}/products/$productId', {
      'api_key'   : apiKey,
      'user_id'   : prefs.idUsuario.toString(),
      'product_id': productId
    });
